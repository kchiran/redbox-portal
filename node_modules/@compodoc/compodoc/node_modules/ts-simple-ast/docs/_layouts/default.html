                        ...
                        <ul class="navbar-nav navbar-default">
                            ...
                            <li class="nav-item{% if page.dir == '/setup/' %} active{% endif %}">
                                ...
                                <ul>
                                    ...
                                    <li class="{% if page.path == 'setup/adding-source-files.md' %}active{% endif %}"><a href="{{ "/setup/adding-source-files" | prepend: site.baseurl }}">Adding SourceFiles</a></li>
                            ...
                            <li class="nav-item{% if page.dir == '/navigation/' %} active{% endif %}">
                                ...
                                <ul>
                                    <li class="{% if page.path == 'navigation/getting-source-files.md' %}active{% endif %}"><a href="{{ "/navigation/getting-source-files" | prepend: site.baseurl }}">Getting SourceFiles</a></li>
