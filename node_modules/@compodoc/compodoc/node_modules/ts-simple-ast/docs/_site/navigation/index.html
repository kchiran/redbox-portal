        ...
        <div class="container">
            <div class="row">
                ...
                <section class="container-fluid col-md-9">
                    <h2 id="navigating-the-ast">Navigating the AST</h2>

<p>Navigating the AST should be simple and straightforward.</p>

<p>I will slowly be adding documentation for this area. Right now, the best way to explore what’s implemented is to look at the autocompletion/intellisense results.
If you can’t find something that means it’s most likely not implemented and you should <a href="https://github.com/dsherret/ts-simple-ast/issues">open an issue</a> on GitHub.</p>

<p><strong>Next step:</strong> <a href="getting-sourcefiles">Getting SourceFiles</a></p>
