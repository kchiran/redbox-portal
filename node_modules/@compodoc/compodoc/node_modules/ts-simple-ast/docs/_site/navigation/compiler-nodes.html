...
<p>They’re accessible via the <code class="highlighter-rouge">.getCompilerNode()</code> method that’s found on most objects:</p>

<div class="language-typescript highlighter-rouge"><pre class="highlight"><code><span class="kd">const</span> <span class="nx">compilerNode</span> <span class="o">=</span> <span class="nx">personInterface</span><span class="p">.</span><span class="nx">getCompilerNode</span><span class="p">();</span>
</code></pre>
</div>
...
<p><strong>Next step:</strong> <a href="../manipulation/index">Manipulating the AST</a></p>
