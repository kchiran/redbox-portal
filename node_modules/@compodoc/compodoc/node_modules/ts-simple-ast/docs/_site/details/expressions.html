        ...
        <div class="container">
            <div class="row">
                        ...
                        <ul class="navbar-nav navbar-default">
                            ...
                            <li class="">
                                ...
                                <ul>
                                    ...
                                    <li class="active"><a href="/details/expressions">Expressions</a></li>
                                    <li>--</li>
                ...
                <section class="container-fluid col-md-9">
                    <h2 id="expression-with-type-arguments">Expression With Type Arguments</h2>

<p>These are found in certain areas. For example <code class="highlighter-rouge">extends</code> and <code class="highlighter-rouge">implements</code> expressions.</p>

<h3 id="getting-expression">Getting expression</h3>

<div class="language-typescript highlighter-rouge"><pre class="highlight"><code><span class="c1">// returns: ts.LeftHandSideExpression</span>
<span class="kd">const</span> <span class="nx">expression</span> <span class="o">=</span> <span class="nx">expressionWithTypeArgs</span><span class="p">.</span><span class="nx">getExpression</span><span class="p">();</span> <span class="c1">// returns: Node</span>
</code></pre>
</div>

<h3 id="getting-type-arguments">Getting type arguments</h3>

<div class="language-typescript highlighter-rouge"><pre class="highlight"><code><span class="kd">const</span> <span class="nx">typeArgs</span> <span class="o">=</span> <span class="nx">expressionWithTypeArgs</span><span class="p">.</span><span class="nx">getTypeArguments</span><span class="p">();</span> <span class="c1">// returns: TypeNode[]</span>
</code></pre>
</div>
