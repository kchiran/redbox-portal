                        ...
                        <ul class="navbar-nav navbar-default">
                            ...
                            <li class="">
                                ...
                                <ul>
                                    ...
                                    <li class="active"><a href="/details/generators">Generators</a></li>
...
<p>Nodes like <code class="highlighter-rouge">FunctionDeclaration</code> and <code class="highlighter-rouge">MethodDeclaration</code> can be generators.</p>

<h3 id="tell-if-a-generator">Tell if a generator</h3>

<div class="language-typescript highlighter-rouge"><pre class="highlight"><code><span class="nx">functionDeclaration</span><span class="p">.</span><span class="nx">isGenerator</span><span class="p">();</span> <span class="c1">// returns: boolean</span>
</code></pre>
</div>

<h3 id="set-as-a-generator">Set as a generator</h3>

<div class="language-typescript highlighter-rouge"><pre class="highlight"><code><span class="nx">functionDeclaration</span><span class="p">.</span><span class="nx">setIsGenerator</span><span class="p">(</span><span class="kc">true</span><span class="p">);</span> <span class="c1">// or false to set as not one</span>
</code></pre>
</div>

<h3 id="get-asterisk-token-">Get asterisk token (<code class="highlighter-rouge">*</code>)</h3>

<p>Gets the asterisk token or undefined if not exists:</p>

<div class="language-typescript highlighter-rouge"><pre class="highlight"><code><span class="nx">functionDeclaration</span><span class="p">.</span><span class="nx">getAsteriskToken</span><span class="p">();</span>
</code></pre>
</div>
