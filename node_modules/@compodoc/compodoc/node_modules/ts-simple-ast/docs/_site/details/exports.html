...
<p>Use the <code class="highlighter-rouge">isNamedExport()</code> and <code class="highlighter-rouge">isDefaultExport()</code> methods:</p>

<div class="language-typescript highlighter-rouge"><pre class="highlight"><code><span class="nx">functionDeclaration</span><span class="p">.</span><span class="nx">isNamedExport</span><span class="p">();</span> <span class="c1">// returns: boolean</span>
