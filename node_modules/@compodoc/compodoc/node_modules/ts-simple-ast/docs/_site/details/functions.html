                        ...
                        <ul class="navbar-nav navbar-default">
                            ...
                            <li class="">
                                ...
                                <ul>
                                    ...
                                    <li class="active"><a href="/details/functions">Functions</a></li>
...
<p>Functions can be retrieved from source files, other namespaces, or function bodies:</p>

<div class="language-typescript highlighter-rouge"><pre class="highlight"><code><span class="kd">const</span> <span class="nx">functions</span> <span class="o">=</span> <span class="nx">sourceFile</span><span class="p">.</span><span class="nx">getFunctions</span><span class="p">();</span>
<span class="kd">const</span> <span class="nx">function1</span> <span class="o">=</span> <span class="nx">sourceFile</span><span class="p">.</span><span class="nx">getFunction</span><span class="p">(</span><span class="s2">"Function1"</span><span class="p">);</span>
<span class="kd">const</span> <span class="nx">firstFunctionWithChildFunction</span> <span class="o">=</span> <span class="nx">sourceFile</span><span class="p">.</span><span class="nx">getFunction</span><span class="p">(</span><span class="nx">f</span> <span class="o">=&gt;</span> <span class="nx">f</span><span class="p">.</span><span class="nx">getFunctions</span><span class="p">().</span><span class="nx">length</span> <span class="o">&gt;</span> <span class="mi">0</span><span class="p">);</span>
</code></pre>
</div>

<p>Most of the information you can get about functions is covered in other sections.</p>
