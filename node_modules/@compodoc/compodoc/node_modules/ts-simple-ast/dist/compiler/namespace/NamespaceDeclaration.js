...
exports.NamespaceDeclarationBase = base_1.UnwrappableNode(base_1.TextInsertableNode(base_1.BodiedNode(NamespaceChildableNode_1.NamespaceChildableNode(statement_1.StatementedNode(base_1.DocumentationableNode(base_1.AmbientableNode(base_1.ExportableNode(base_1.ModifierableNode(base_1.NamedNode(common_1.Node))))))))));
var NamespaceDeclaration = /** @class */ (function (_super) {
    ...
    NamespaceDeclaration.prototype.getName = function () {
        return this.getNameIdentifiers().map(function (n) { return n.getText(); }).join(".");
    };
    /**
    ...
    NamespaceDeclaration.prototype.setName = function (newName) {
        var nameNodes = this.getNameIdentifiers();
     ...
     */
    NamespaceDeclaration.prototype.getNameIdentifiers = function () {
        var nodes = [];
        var current = this;
        do {
