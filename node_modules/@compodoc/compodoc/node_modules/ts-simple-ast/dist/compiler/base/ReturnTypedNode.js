...
function ReturnTypedNode(Base) {
    return /** @class */ (function (_super) {
        ...
        class_1.prototype.setReturnType = function (text) {
            ...
            var colonToken = returnTypeNode == null ? undefined : returnTypeNode.getPreviousSiblingIfKindOrThrow(ts.SyntaxKind.ColonToken);
            var replaceLength = colonToken == null ? 0 : returnTypeNode.getEnd() - colonToken.getPos();
            // insert new type
            var closeParenToken = this.getFirstChildByKindOrThrow(ts.SyntaxKind.CloseParenToken);
...
//# sourceMappingURL=ReturnTypedNode.js.map
