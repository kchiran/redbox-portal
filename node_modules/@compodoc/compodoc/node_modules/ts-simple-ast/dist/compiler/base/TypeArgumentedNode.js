    ...
    return /** @class */ (function (_super) {
        ...
        class_1.prototype.getTypeArguments = function () {
            ...
            if (this.compilerNode.typeArguments == null)
                return [];
            return this.compilerNode.typeArguments.map(function (a) { return _this.global.compilerFactory.getNodeFromCompilerNode(a, _this.sourceFile); });
        };
        ...
        class_1.prototype.insertTypeArguments = function (index, argumentTexts) {
            ...
            if (typeArguments.length === 0) {
                ...
                manipulation_1.insertIntoCommaSeparatedNodes({ parent: this, currentNodes: typeArguments, insertIndex: index, newTexts: argumentTexts });
            }
