...
let EmailNotificationService = class EmailNotificationService extends base_service_1.BaseService {
    constructor(http, configService) {
        super(http, configService);
        this.configService = configService;
    }
    sendNotification(to, template, data = {}, subject = null, from = null) {
