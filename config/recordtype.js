        ...
        post: [
          ...
          // `Email "data publication is staged" notification to FNCI, DM, Supervisor with link to landing page on Staging`
          {
            ...
            options: {
              ...
              to: "<%= record.metadata.contributor_ci.email %>,<%= record.metadata.contributor_data_manager.email %>,{{ DATA_LIBRARIAN_EMAIL }}",
          ...
          // Triggers "Published" Email Notification to FNCI, DM, Collaborators, CC: librarian with RDA link
          {
            ...
            options: {
              ...
              to: "<%= record.metadata.contributor_ci.email %>,<%= record.metadata.contributor_data_manager.email %>,{{ DATA_LIBRARIAN_EMAIL }},<%= _.isEmpty(record.metadata.creators) ? '' : _.join(_.map(record.metadata.creators, (creator)=>{ return creator.email; }), ',') %>",
        ...
        post: [
          ...
          },
          {
            ...
            options: {
              ...
              template: "publicationStaged",
              onNotifySuccess: [
                // `Email "data publication is ready for review" notification to Librarian {{ DATA_LIBRARIAN_EMAIL }} with a link to the data publication record`
                {
                  function: 'sails.services.emailservice.sendRecordNotification',
                  options: {
                    forceRun: true,
          ...
          },
          {
            ...
            options: {
              ...
              site: '{{ REDBOX_PORTAL_DATAPUBS_PUBLIC_NGINX }}'
            }
          },
          // Triggers "Published" Email Notification to FNCI, DM, Collaborators, CC: librarian with RDA link
          {
